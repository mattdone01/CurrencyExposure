...
namespace CurrencyExposure.Repository.Xero
{
    ...
    public static class XeroApiHelper
    {
        ...
        {
			var callbackUrl = "http://localhost/CurrencyExposure.Web/Home/Authorize";
            ...
            var publicAppConsumerKey = "TV1KKJBGHFUARJEJUIOF96ELTPF6K5";
			var publicAppConsumerSecret = "VLZPP5R6LTZ2U9EAUOTAMSDK18A8OM";
